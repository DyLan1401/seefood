...
export default function ProductCard({ name, slug, image_url, id, created_at }: Category) {
    return (
        <div className="w-60 h-80  border-2 border-neutral-400   rounded-3xl p-4 flex flex-col items-start justify-center gap-3 ">
            ...
            <button className="bg-[#2C8DE0] font-extrabold  text-white p-2 px-6 rounded-xl 0 transition-colors">Mua</button>
        </div>
    )
};